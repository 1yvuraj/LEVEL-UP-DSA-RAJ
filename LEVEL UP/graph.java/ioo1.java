//dfs 
// 1 marks
// 2  call all unvisted nbrs
//    2.1 dfs call
//tc O(e) hoti hai ak dfs ki
// tc jab sare jane ak dure se connect ho to 
// e-->v2 ban jata hai
// or tc=v2  hoti hai
//pr always o(E) bolo
...
public class l001 {
    ...
    // BFS.=======================================================================
    // when cycle to ye always
    //E is se thoda easy ho jata hai bas pr niche wale me extra vertex nhi dalte becouse of is condition
    ...
    // cycle is odd to non bipartite
    //cycle is even to  bipartite
    //non cycle is  bipartite
    //dekh cycle wale me bas vertix ko mark kar rhe or is ke next wale ke hum for ke if me likte jis se sare nbr mark hi jate hai
    ...
    //jab cycle ka na ho to ye kuki kuch time bachta hai yr
    public static void bipartite(ArrayList<Edge>[] graph, int src, int[] vis) {
        LinkedList<Integer> que = new LinkedList<>();
        que.addLast(src);
